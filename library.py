...
print(f'Number of books available in the books_with_details list: {num_books}')
...
author = 'Yuval Noah Harari'
author_books = search_by_author(author)
if author_books:
    print(f'Books by {author}: {", ".join(author_books)}')
else:
